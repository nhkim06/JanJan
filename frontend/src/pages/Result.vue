<template>
  ...
  >
    <div class="w-full max-w-md md:max-w-2xl lg:max-w-3xl space-y-6 relative">
      <!-- 상단 네비게이션 -->
      <div class="flex items-center justify-between w-full py-2">
        ...
        <span class="text-sm md:text-base font-semibold text-slate-500">진단 결과</span>
        <div class="w-10"></div>
      </div>

      <!-- 요약 정보 -->
      <div
        class="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-slate-100 mb-2"
      >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- 금액 추천 섹션 -->
        <div
          class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 text-center relative overflow-hidden flex flex-col justify-center"
        >
          <h2 class="text-sm md:text-base font-medium text-slate-400 mb-2">적정 추천 금액</h2>
          <div class="text-5xl md:text-6xl font-black tracking-tight mb-2 text-slate-900">
        ...
        <div class="space-y-6">
          <!-- 금기사항 -->
          <div class="bg-rose-50/40 rounded-3xl p-6 border border-rose-100/70 h-full">
            ...
            <ul
              class="list-disc pl-5 text-sm md:text-base font-medium text-rose-700/90 space-y-2"
            >
              <li>안 친한데 가족 대동</li>
            </ul>
          </div>
          ...
          <!-- 추천 선물 -->
          <div class="bg-emerald-50/30 rounded-3xl p-6 border border-emerald-100 h-full">
            ...
            <ul
              class="list-disc pl-5 text-sm md:text-base font-medium text-emerald-800/90 space-y-2"
            >
              <li>축의금</li>
            </ul>
          </div>
      ...
      <div class="pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <button
          ...
          class="md:col-span-2 w-full bg-[#0f1423] text-white hover:bg-slate-800 active:scale-[0.99] transition py-4 px-6 rounded-2xl font-bold text-base md:text-lg flex items-center justify-center shadow-md"
        >
          <font-awesome-icon
